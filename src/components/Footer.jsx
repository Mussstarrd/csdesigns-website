...
export default function Footer() {
  return (
    <footer className="border-t border-cs-line mt-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          ...
          <div className="flex flex-col items-start md:items-end gap-3">
            <div className="flex gap-6 font-mono text-xs uppercase tracking-widest">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-cs-muted hover:text-cs-cyan transition-colors">LinkedIn</a>
              <a href="https://behance.net" target="_blank" rel="noreferrer" className="text-cs-muted hover:text-cs-cyan transition-colors">Behance</a>
            </div>
