    ...
    <section className="max-w-6xl mx-auto px-5 sm:px-6 py-24 md:py-24 border-t border-cs-line/40">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full py-3 border border-cs-blue text-cs-blue font-mono text-xs uppercase tracking-[0.25em] hover:bg-cs-blue hover:text-cs-bg transition-all shadow-blue hover:shadow-blue-strong"
          >
            Transmit ▸
          </button>
        </form>
